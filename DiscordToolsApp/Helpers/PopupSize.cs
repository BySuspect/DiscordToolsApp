...
namespace DiscordToolsApp.Helpers
{
    public static class PopupSize
    {
        ...
        public static Size Tall2 => new Size(0.9 * (DeviceDisplay.MainDisplayInfo.Width / DeviceDisplay.MainDisplayInfo.Density), 0.7 * (DeviceDisplay.MainDisplayInfo.Width / DeviceDisplay.MainDisplayInfo.Density));
