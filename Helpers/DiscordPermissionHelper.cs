namespace DiscordToolsApp.Helpers
{
    ...
    {
        private static readonly Dictionary<string, ulong> permissionMap = new Dictionary<
            string,
            ulong
        >
        {
        ...
        private static readonly Dictionary<string, string> PermissionTitleMap = new Dictionary<
            string,
            string
        >
        {
        ...
        public static readonly List<string> PermissionIds = new List<string>
        {
            "ADMINISTRATOR",
            "MANAGE_GUILD",
            "MODERATE_MEMBERS",
